...
class TestAuthentication:
    def test_token_obtain_success(
        self, api_client_without_login, user_instance: tuple[User, str]
    ):
    ...
    def test_token_obtain_fail_wrong_credentials(
        self, api_client_without_login, user_instance
    ):
        response = api_client_without_login.post(
            reverse("api_v1:token_obtain_pair"),
    ...
    def test_token_refresh_success(self, api_client_without_login, user_instance):
    ...
    def test_token_refresh_fail_invalid_token(
        self, api_client_without_login, user_instance
    ):
        response = api_client_without_login.post(
